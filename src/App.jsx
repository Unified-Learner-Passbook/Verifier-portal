...
function App() {
  ...
  async function onClickRequest() {
    ...
    if(!result) document.getElementById('getResults').innerText =
  ...
  return (
    ...
    <div className="font-bold text-center text-5xl" style={{
          position: 'absolute',
          top: '42%',
          width: '100%',
          textAlign: 'center',
  ...
  <div className="container mt-32 mx-auto p-4 md:p-0">
    ...
    <div className="shadow-lg flex flex-wrap w-full lg:w-4/5 mx-auto">
      {/* <!-- Card image --> */}
      <div className="bg-cover bg-bottom border w-full md:w-1/3 h-64 md:h-auto relative" style={{
      ...
      <div className="bg-white w-full md:w-2/3">
        ...
        <div className="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
          ...
          <div
            className="bg-white lg:h-full p-6 -mt-6 md:mt-0 relative mb-4 md:mb-0 flex flex-wrap md:flex-wrap items-center">
            ...
            <div className="w-full lg:w-1/5 lg:border-right lg:border-solid text-center md:text-left">
              ...
              <p className="mb-0 mt-3 text-grey-dark text-sm italic">Samagra</p>
            ...
            <div className="w-full lg:w-3/5 lg:px-3">
              <p className="text-md mt-4 lg:mt-0 text-justify md:text-left text-sm">
                The Product Manager is responsible for the product planning
                and execution throughout the Product Lifecycle, including:
                gathering and prioritizing product and customer requirements,
                defining the product vision, and working closely with
                engineering, sales, marketing and support to ensure revenue
                and customer satisfaction goals are met. The Product Manager
                also ensures that the product supports the company’s overall
                strategy and goals.
              </p>
            </div>
            <div className="w-full lg:w-1/5 mt-6 lg:mt-0 lg:px-4 text-center md:text-left">
              ...
              <button
                className="bg-green-500 hover:bg-grey-darker hover:bg-green-900 border border-solid border-grey w-1/3 lg:w-full py-2 text-white hover:border hover:border-blue-500 mt-3">
                Scan QR
              </button>
            </div>
  ...
  <div className="container mt-32 mx-auto p-4 md:p-0 mb-32">
    ...
    <div className="shadow-lg flex flex-wrap w-full lg:w-4/5 mx-auto">
      {/* <!-- Card image --> */}
      <div className="bg-cover bg-bottom border w-full md:w-1/3 h-64 md:h-auto relative" style={{
            backgroundImage: "url('https://images7.alphacoders.com/347/347550.jpg')"
          }}>
        <div className="absolute text-xl">
          <i className="fa fa-heart text-white hover:text-red-light ml-4 mt-4 cursor-pointer"></i>
        </div>
      ...
      <div className="bg-white w-full md:w-2/3">
        ...
        <div className="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
          ...
          <div
            ...
            <div className="w-full lg:w-3/5 lg:px-3">
              <p className="text-md mt-4 lg:mt-0 text-justify md:text-left text-sm">
                We are looking for an innovative, dedicated engineer who has a
                broad and general fascination with the engineering sciences
                and who follows international engineering trends and
                technologies. The engineer’s responsibilities include defining
                problems, researching, interpreting, and applying information,
                developing solutions, and making decisions.<br />
      ...
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div className="outer-border">
          <div className="inner-dotted-border">
            ...
            <br/><br/>
            <span className="name"><b>Daniel Vitorrie</b></span><br /><br />
            <span className="certify"><i>has successfully completed the certification</i></span> <br /><br />
            <span className="fs-30">Java Developer</span> <br /><br />
            <span className="fs-20">with score of <b>A+</b></span> <br /><br />
            <span className="certify"><i>dated</i></span><br/>

            <span className="fs-30" style={{marginTop: '10px'}}>23 March,2019</span>
